...
bounds_dictionary = {'FCepsilonRI/k_f1': [-3,2], 'FCepsilonRI/k_f2': [-3,2],'FCepsilonRI/k_f3': [-3,2], 'FCepsilonRI/k_f4': [-3,2],
	 'FCepsilonRI/k_f5': [-3,2], 'FCepsilonRI/k_f6': [-3,2], 'FCepsilonRI/k_f7': [-3,2], 
	 'FCepsilonRI/k_r1': [-3,2], 'FCepsilonRI/k_r4': [-3,2], 'FCepsilonRI/k_r6': [-3,2], 
         'FCepsilonRI/Pi': [-3,2]}
...
#fit_parameters_exclude = ['FCepsilonRI/k_f3']
...
class Simulation(object):
    ...
    def plot_n_best(self,n,param_sweep_results):
        ...
        ax3.plot(param_sweep_results[0:n,1],"*")
...
fig, ax = plt.subplots()
plt.plot(times, exp_data[0,:], 'o', label='Experiment pGrb2', color='red')
plt.plot(times, f, '-', label='Model pGr2', color='blue')
pGrb2_error = abs(f - exp_data[0,:])

print('pGrb2 error = ' + str(np.mean(pGrb2_error)) + ' (SD ' + str(np.std(pGrb2_error)) +')')
